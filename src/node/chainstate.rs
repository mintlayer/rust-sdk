...
impl Client {
    ...
    pub async fn block(&self, id: &str) -> Result<Option<String>, Error> {
        self.call("chainstate_get_block", &serde_json::json!({ "id": id })).await
    }
