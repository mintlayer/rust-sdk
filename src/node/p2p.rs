...
impl Client {
    ...
    pub async fn peer_count(&self) -> Result<u64, Error> {
        self.call("p2p_get_peer_count", &serde_json::json!({})).await
    }
    ...
    pub async fn unban(&self, address: &str) -> Result<(), Error> {
        self.call("p2p_unban", &serde_json::json!({ "address": address })).await
    }
